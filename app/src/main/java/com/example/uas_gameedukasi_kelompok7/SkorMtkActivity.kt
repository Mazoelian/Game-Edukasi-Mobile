...
class SkorMtkActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_skor_mtk)
        ...
        btnRetry.setOnClickListener {
            val level = intent.getStringExtra("LEVEL") ?: "level1" // Default ke level1 jika null
